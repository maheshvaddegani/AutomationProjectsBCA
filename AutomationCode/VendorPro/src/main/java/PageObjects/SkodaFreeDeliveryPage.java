...
public class SkodaFreeDeliveryPage {
	 ...
	 private By SkodaFD = By.xpath("(//span[@class='slds-radio--faux'])[3]");
	 private By Next = By.xpath("//span[text()='Next']");
	 private By AssertPage1 = By.xpath("//h2[text()='New Target: Free Delivery']");
	  
	 private By Brand = By.xpath("(//input[@role='combobox'])[1]");
	 private By Brandname = By.xpath("//lightning-base-combobox-item[@data-value='Skoda']");
	 ...
	 private By TargetType = By.xpath("(//input[@role='combobox'])[6]");
	  ...
	  private By AssertValue2 = By.xpath("//span[text()='Free Delivery']");
	  ...
	  public SkodaFreeDeliveryPage(WebDriver driver)
	  {
		  this.driver = driver;
	  }
/*------------------------------------------------------------------Create New Target----------------------------------------------------------------------*/	  
	  ...
	  {   
	      ...
	      driver.findElement(SkodaFD).click();
	  ...
	  public void UserFillsMandatoryFields() throws InterruptedException
	  {
		  WebDriverWait wait2 = new WebDriverWait(driver,1000);
	 	  wait2.until(ExpectedConditions.elementToBeClickable(Brand));	   
	 	  driver.findElement(Brand).click();
	      WebDriverWait wait3 = new WebDriverWait(driver,1000);
	 	  wait3.until(ExpectedConditions.elementToBeClickable(Brandname));	  
		  driver.findElement(Brandname).click();
		  
		  driver.findElement(TargetNote).sendKeys("Skoda free Delivery");
...
/*------------------------------------------------------------------IMS/VP2----------------------------------------------------------------------*/	
		  ...
		  {   
			  ...
			  WebDriverWait wait = new WebDriverWait(driver,100);
		  wait.until(ExpectedConditions.visibilityOfElementLocated(Purchasestatus));
		      driver.findElement(Purchasestatus).click();
		      WebElement from5 = driver.findElement(Purchasestatus); 
		      Thread.sleep(1500);
		      from5.sendKeys(Keys.ARROW_DOWN);
		  ...
		  public String AssertDeliveryRebate()
		  {   
			  WebDriverWait wait = new WebDriverWait(driver,100);
